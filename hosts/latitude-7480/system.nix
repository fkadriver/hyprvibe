...
let
  ...
  wallpaperPath = "/home/scott/build/config/hosts/latitude-7840/aesthetic_8_bit_art-wallpaper-3840x2160.jpg";
...
in
{
  ...
  shared.hyprland.monitorsFile = ../../configs/hyprland-monitors-latitude-7840.conf;
  ...
  system.autoUpgrade = {
    enable = true;
    flake = "github:fkadriver/hyprvibe#latitude-7840";
    operation = "boot";
  ...
  system.activationScripts.copyHyprlandConfig = ''
    ...
    cp ${../../configs/hyprland-monitors-latitude-7840.conf} /home/scott/.config/hypr/hyprland-monitors-rvbee.conf
